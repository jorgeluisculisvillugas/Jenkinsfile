...
import com.google.api.client.http.javanet.NetHttpTransport; /*Importe adicional de la libreria */
import com.google.api.client.json.jackson2.JacksonFactory;  /*Importe adicional de la libreria */
